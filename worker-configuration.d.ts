/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f9e71dc5f542d052132966bc5fd956ae)
// Runtime types generated with workerd@1.20260603.1 2026-06-04 nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMIT_KV: KVNamespace;
	STATIC_META_KV: KVNamespace;
	RT_FEED_KV: KVNamespace;
	nta_static: D1Database;
	ENABLE_JSON: "true";
	NTA_POLLER: DurableObjectNamespace<import("./src/index").NtaPollerDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "NtaPollerDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENABLE_JSON">> {}
}
